 ...
 * <ul>
 *   <li>{@link IFC2X3.impl.IfcExternallyDefinedSymbolImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link IFC2X3.impl.IfcExternallyDefinedSymbolImpl#getItemReference <em>Item Reference</em>}</li>
 *   <li>{@link IFC2X3.impl.IfcExternallyDefinedSymbolImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcExternallyDefinedSymbolImpl extends IfcDefinedSymbolSelectImpl implements IfcExternallyDefinedSymbol {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == IfcExternalReference.class) {
			switch (derivedFeatureID) {
				case IFC2X3Package.IFC_EXTERNALLY_DEFINED_SYMBOL__LOCATION: return IFC2X3Package.IFC_EXTERNAL_REFERENCE__LOCATION;
				case IFC2X3Package.IFC_EXTERNALLY_DEFINED_SYMBOL__ITEM_REFERENCE: return IFC2X3Package.IFC_EXTERNAL_REFERENCE__ITEM_REFERENCE;
				case IFC2X3Package.IFC_EXTERNALLY_DEFINED_SYMBOL__NAME: return IFC2X3Package.IFC_EXTERNAL_REFERENCE__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == IfcExternalReference.class) {
			switch (baseFeatureID) {
				case IFC2X3Package.IFC_EXTERNAL_REFERENCE__LOCATION: return IFC2X3Package.IFC_EXTERNALLY_DEFINED_SYMBOL__LOCATION;
				case IFC2X3Package.IFC_EXTERNAL_REFERENCE__ITEM_REFERENCE: return IFC2X3Package.IFC_EXTERNALLY_DEFINED_SYMBOL__ITEM_REFERENCE;
				case IFC2X3Package.IFC_EXTERNAL_REFERENCE__NAME: return IFC2X3Package.IFC_EXTERNALLY_DEFINED_SYMBOL__NAME;
				default: return -1;
			}
		}
