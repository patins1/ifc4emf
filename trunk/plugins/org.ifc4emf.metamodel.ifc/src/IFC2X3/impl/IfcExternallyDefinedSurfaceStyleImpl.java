 ...
 * <ul>
 *   <li>{@link IFC2X3.impl.IfcExternallyDefinedSurfaceStyleImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link IFC2X3.impl.IfcExternallyDefinedSurfaceStyleImpl#getItemReference <em>Item Reference</em>}</li>
 *   <li>{@link IFC2X3.impl.IfcExternallyDefinedSurfaceStyleImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcExternallyDefinedSurfaceStyleImpl extends IfcSurfaceStyleElementSelectImpl implements IfcExternallyDefinedSurfaceStyle {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == IfcExternalReference.class) {
			switch (derivedFeatureID) {
				case IFC2X3Package.IFC_EXTERNALLY_DEFINED_SURFACE_STYLE__LOCATION: return IFC2X3Package.IFC_EXTERNAL_REFERENCE__LOCATION;
				case IFC2X3Package.IFC_EXTERNALLY_DEFINED_SURFACE_STYLE__ITEM_REFERENCE: return IFC2X3Package.IFC_EXTERNAL_REFERENCE__ITEM_REFERENCE;
				case IFC2X3Package.IFC_EXTERNALLY_DEFINED_SURFACE_STYLE__NAME: return IFC2X3Package.IFC_EXTERNAL_REFERENCE__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == IfcExternalReference.class) {
			switch (baseFeatureID) {
				case IFC2X3Package.IFC_EXTERNAL_REFERENCE__LOCATION: return IFC2X3Package.IFC_EXTERNALLY_DEFINED_SURFACE_STYLE__LOCATION;
				case IFC2X3Package.IFC_EXTERNAL_REFERENCE__ITEM_REFERENCE: return IFC2X3Package.IFC_EXTERNALLY_DEFINED_SURFACE_STYLE__ITEM_REFERENCE;
				case IFC2X3Package.IFC_EXTERNAL_REFERENCE__NAME: return IFC2X3Package.IFC_EXTERNALLY_DEFINED_SURFACE_STYLE__NAME;
				default: return -1;
			}
		}
