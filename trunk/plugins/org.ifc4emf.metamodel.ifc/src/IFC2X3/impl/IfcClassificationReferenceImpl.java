 ...
 * <ul>
 *   <li>{@link IFC2X3.impl.IfcClassificationReferenceImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link IFC2X3.impl.IfcClassificationReferenceImpl#getItemReference <em>Item Reference</em>}</li>
 *   <li>{@link IFC2X3.impl.IfcClassificationReferenceImpl#getName <em>Name</em>}</li>
 *   <li>{@link IFC2X3.impl.IfcClassificationReferenceImpl#getReferencedSource <em>Referenced Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcClassificationReferenceImpl extends IfcClassificationNotationSelectImpl implements IfcClassificationReference {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == IfcExternalReference.class) {
			switch (derivedFeatureID) {
				case IFC2X3Package.IFC_CLASSIFICATION_REFERENCE__LOCATION: return IFC2X3Package.IFC_EXTERNAL_REFERENCE__LOCATION;
				case IFC2X3Package.IFC_CLASSIFICATION_REFERENCE__ITEM_REFERENCE: return IFC2X3Package.IFC_EXTERNAL_REFERENCE__ITEM_REFERENCE;
				case IFC2X3Package.IFC_CLASSIFICATION_REFERENCE__NAME: return IFC2X3Package.IFC_EXTERNAL_REFERENCE__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == IfcExternalReference.class) {
			switch (baseFeatureID) {
				case IFC2X3Package.IFC_EXTERNAL_REFERENCE__LOCATION: return IFC2X3Package.IFC_CLASSIFICATION_REFERENCE__LOCATION;
				case IFC2X3Package.IFC_EXTERNAL_REFERENCE__ITEM_REFERENCE: return IFC2X3Package.IFC_CLASSIFICATION_REFERENCE__ITEM_REFERENCE;
				case IFC2X3Package.IFC_EXTERNAL_REFERENCE__NAME: return IFC2X3Package.IFC_CLASSIFICATION_REFERENCE__NAME;
				default: return -1;
			}
		}
