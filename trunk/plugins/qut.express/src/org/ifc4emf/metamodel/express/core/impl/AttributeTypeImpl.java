 ...
 * <ul>
 *   <li>{@link org.ifc4emf.metamodel.express.core.impl.AttributeTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.ifc4emf.metamodel.express.core.impl.AttributeTypeImpl#getConstraints <em>Constraints</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AttributeTypeImpl extends EObjectImpl implements AttributeType {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.ATTRIBUTE_TYPE;
	}
	...
	public EList<Attribute> getRole() {
		if (role == null) {
			role = new EObjectWithInverseResolvingEList<Attribute>(Attribute.class, this, CorePackage.ATTRIBUTE_TYPE__ROLE, CorePackage.ATTRIBUTE__ATTRIBUTE_TYPE);
		}
		return role;
	}
	...
	public EList<DomainConstraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectWithInverseResolvingEList<DomainConstraint>(DomainConstraint.class, this, CorePackage.ATTRIBUTE_TYPE__CONSTRAINTS, CorePackage.DOMAIN_CONSTRAINT__DOMAIN);
		}
		return constraints;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.ATTRIBUTE_TYPE__ROLE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRole()).basicAdd(otherEnd, msgs);
			case CorePackage.ATTRIBUTE_TYPE__CONSTRAINTS:
