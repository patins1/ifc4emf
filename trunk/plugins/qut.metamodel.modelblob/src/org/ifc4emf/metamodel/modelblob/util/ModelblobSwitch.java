 ...
 * @generated
 */
public class ModelblobSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelblobPackage.CONTAINMENT_TREE_NODE: {
				ContainmentTreeNode containmentTreeNode = (ContainmentTreeNode)theEObject;
				T result = caseContainmentTreeNode(containmentTreeNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelblobPackage.BINARY_TREE_ROOT: {
				BinaryTreeRoot binaryTreeRoot = (BinaryTreeRoot)theEObject;
				T result = caseBinaryTreeRoot(binaryTreeRoot);
				if (result == null) result = caseContainmentTreeNode(binaryTreeRoot);
				if (result == null) result = caseResumableModel(binaryTreeRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelblobPackage.RESUMABLE_MODEL: {
				ResumableModel resumableModel = (ResumableModel)theEObject;
				T result = caseResumableModel(resumableModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
