 ...
 * <ul>
 *   <li>{@link IFC2X3.impl.IfcLibraryReferenceImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link IFC2X3.impl.IfcLibraryReferenceImpl#getItemReference <em>Item Reference</em>}</li>
 *   <li>{@link IFC2X3.impl.IfcLibraryReferenceImpl#getName <em>Name</em>}</li>
 *   <li>{@link IFC2X3.impl.IfcLibraryReferenceImpl#getReferenceIntoLibrary <em>Reference Into Library</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IfcLibraryReferenceImpl extends IfcLibrarySelectImpl implements IfcLibraryReference {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	public IfcLibraryInformation getReferenceIntoLibrary() {
		return (IfcLibraryInformation)eGet(IFC2X3Package.eINSTANCE.getIfcLibraryReference_ReferenceIntoLibrary(), true);
	}
	 ...
	 * @generated
	 */
	public void setReferenceIntoLibrary(IfcLibraryInformation newReferenceIntoLibrary) {
		eSet(IFC2X3Package.eINSTANCE.getIfcLibraryReference_ReferenceIntoLibrary(), newReferenceIntoLibrary);
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == IfcExternalReference.class) {
			switch (derivedFeatureID) {
				case IFC2X3Package.IFC_LIBRARY_REFERENCE__LOCATION: return IFC2X3Package.IFC_EXTERNAL_REFERENCE__LOCATION;
				case IFC2X3Package.IFC_LIBRARY_REFERENCE__ITEM_REFERENCE: return IFC2X3Package.IFC_EXTERNAL_REFERENCE__ITEM_REFERENCE;
				case IFC2X3Package.IFC_LIBRARY_REFERENCE__NAME: return IFC2X3Package.IFC_EXTERNAL_REFERENCE__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == IfcExternalReference.class) {
			switch (baseFeatureID) {
				case IFC2X3Package.IFC_EXTERNAL_REFERENCE__LOCATION: return IFC2X3Package.IFC_LIBRARY_REFERENCE__LOCATION;
				case IFC2X3Package.IFC_EXTERNAL_REFERENCE__ITEM_REFERENCE: return IFC2X3Package.IFC_LIBRARY_REFERENCE__ITEM_REFERENCE;
				case IFC2X3Package.IFC_EXTERNAL_REFERENCE__NAME: return IFC2X3Package.IFC_LIBRARY_REFERENCE__NAME;
				default: return -1;
			}
		}
