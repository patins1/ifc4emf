...
public class Schema2PackageImpl extends EObjectImpl implements Schema2Package {
	 ...
	 * @ordered
	 */
	protected org.ifc4emf.metamodel.express.core.Schema schema;
	 ...
	 * @generated
	 */
	public org.ifc4emf.metamodel.express.core.Schema getSchema() {
		if (schema != null && schema.eIsProxy()) {
			InternalEObject oldSchema = (InternalEObject)schema;
			schema = (org.ifc4emf.metamodel.express.core.Schema)eResolveProxy(oldSchema);
			if (schema != oldSchema) {
	 ...
	 * @generated
	 */
	public org.ifc4emf.metamodel.express.core.Schema basicGetSchema() {
		return schema;
	}
	 ...
	 * @generated
	 */
	public void setSchema(org.ifc4emf.metamodel.express.core.Schema newSchema) {
		org.ifc4emf.metamodel.express.core.Schema oldSchema = schema;
		schema = newSchema;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Express2ecorePackage.SCHEMA2_PACKAGE__SCHEMA:
				setSchema((org.ifc4emf.metamodel.express.core.Schema)newValue);
				return;
			case Express2ecorePackage.SCHEMA2_PACKAGE__PACKAGE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case Express2ecorePackage.SCHEMA2_PACKAGE__SCHEMA:
				setSchema((org.ifc4emf.metamodel.express.core.Schema)null);
				return;
			case Express2ecorePackage.SCHEMA2_PACKAGE__PACKAGE:
