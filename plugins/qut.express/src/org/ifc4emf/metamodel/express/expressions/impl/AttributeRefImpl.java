 ...
 * <ul>
 *   <li>{@link org.ifc4emf.metamodel.express.expressions.impl.AttributeRefImpl#getRefersTo <em>Refers To</em>}</li>
 *   <li>{@link org.ifc4emf.metamodel.express.expressions.impl.AttributeRefImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AttributeRefImpl extends SelectorImpl implements AttributeRef {
	/**
	...
	protected EClass eStaticClass() {
		return ExpressionsPackage.Literals.ATTRIBUTE_REF;
	}
		...
		if (refersTo != null && refersTo.eIsProxy()) {
			...
			if (refersTo != oldRefersTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExpressionsPackage.ATTRIBUTE_REF__REFERS_TO, oldRefersTo, refersTo));
			}
		}
		return refersTo;
	}
	...
	public void setRefersTo(Attribute newRefersTo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.ATTRIBUTE_REF__REFERS_TO, oldRefersTo, refersTo));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.ATTRIBUTE_REF__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExpressionsPackage.ATTRIBUTE_REF__REFERS_TO:
				if (resolve) return getRefersTo();
				return basicGetRefersTo();
			case ExpressionsPackage.ATTRIBUTE_REF__ID:
				return getId();
		}
