 ...
 * <ul>
 *   <li>{@link IFC2X3.impl.IfcExtendedMaterialPropertiesImpl#getExtendedProperties <em>Extended Properties</em>}</li>
 *   <li>{@link IFC2X3.impl.IfcExtendedMaterialPropertiesImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link IFC2X3.impl.IfcExtendedMaterialPropertiesImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcExtendedMaterialPropertiesImpl extends IfcMaterialPropertiesImpl implements IfcExtendedMaterialProperties {
	...
	public void unsetName() {
		eUnset(IFC2X3Package.eINSTANCE.getIfcExtendedMaterialProperties_Name());
	}
	...
	public boolean isSetName() {
		return eIsSet(IFC2X3Package.eINSTANCE.getIfcExtendedMaterialProperties_Name());
	}
