 ...
 * <ul>
 *   <li>{@link org.ifc4emf.metamodel.express.core.impl.ParameterTypeImpl#getContains <em>Contains</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ParameterTypeImpl extends EObjectImpl implements ParameterType {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.PARAMETER_TYPE;
	}
	...
	public EList<GeneralizedType> getContains() {
		if (contains == null) {
			contains = new EObjectWithInverseResolvingEList.ManyInverse<GeneralizedType>(GeneralizedType.class, this, CorePackage.PARAMETER_TYPE__CONTAINS, CorePackage.GENERALIZED_TYPE__OCCURS_IN);
		}
		return contains;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.PARAMETER_TYPE__CONTAINS:
